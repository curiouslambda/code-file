"""
Django settings for car_break project.
...
import pymysql, os
from config import DJANGO_CONFIG, MYSQL_CONFIG
...
WSGI_APPLICATION = 'car_break.wsgi.application'
...
AUTH_USER_MODEL = 'car_break.User'
